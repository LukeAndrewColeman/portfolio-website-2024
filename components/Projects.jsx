...
const Projects = () => {
    const projects = [
        ...
        {
            title: "Code Snippets",
            description: "Code Snippets is a website that provides a way of organising all your code snippets for various programming languages. The website is hosted on a vps with coolify and has a MySQL database.",
                            ...
                            <div className="bg-white rounded-md shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl group flex flex-col max-w-[400px]">
                                ...
                                <div className="p-6 flex flex-col flex-grow overflow-auto bg-luke-light-blue bg-opacity-10">
                                    <div className="flex gap-4 justify-between">
                                        <h3 className="text-2xl font-bold mb-3 text-luke-light-blue">{project.title}</h3>
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-auto pt-4">
                                        {project.technologies.map((tech, i) => (
                                            <span key={i} className="bg-luke-green bg-opacity-10 text-luke-green px-3 py-1 rounded-full text-xs font-medium">
                                                {tech}
                                            </span>
                                        ))}
                                    </div>
