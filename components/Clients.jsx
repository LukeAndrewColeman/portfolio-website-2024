    ...
    <section className="bg-gradient-to-l from-luke-dark-blue to-luke-light-blue py-20 relative">
      <div className="container mx-auto flex flex-col items-center relative z-10">
        ...
        <div className="w-full max-w-4xl px-10">
          <Slider {...settings}>
            <div className="px-4">
              <Image src={Arrow} alt="Arrow" height={20} className="mx-auto" />
            </div>
            <div className="px-4">
              <Image src={Alveo} alt="Alveo" height={30} className="mx-auto" />
            </div>
            <div className="px-4">
              <Image src={Ugp} alt="UGP" height={40} className="mx-auto" />
            </div>
            <div className="px-4">
              <Image
                src={Springfield}
