...
const Contact = () => {
    return (
        <section id="contact" className="py-10 text-white relative overflow-hidden bg-luke-white">
            <div className="shadow max-w-[800px] py-10 bg-gradient-to-r from-luke-dark-blue to-luke-light-blue mx-8 md:mx-auto flex flex-col items-center rounded-xl relative z-10">
                ...
                <a href="mailto:lukecoleman123@gmail.com">
                    <button className="py-2 px-6 mt-10 bg-luke-green hover:bg-luke-hover transition-colors duration-300 text-white font-bold rounded-3xl shadow">Get in Touch</button>
                </a>
            </div>
        </section>
    );
